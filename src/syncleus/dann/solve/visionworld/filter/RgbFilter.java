...
/**
 * Filters pixels against the provided thresholds and provides the fraction of
 * those meeting the threshold against the provided lower and upper bound.
 *
 * <p>
 * Threshold values may be positive and negative. Negative values are meaningful
 * and represent an upper bound e.g. a red threshold of -100 would match against
 * any pixel whose red value is less than 100. Positive thresholds are will
 * match if the provided value is greater than or equal to the threshold.
 *
 * @author Matt Watson
 */
public class RgbFilter implements Filter {
    ...
    double scale(final int pixels, final int total) {
        ...
        LOGGER.debug("pixels: " + pixels + " total: " + total + " scaled: "
                + fraction * distance);
