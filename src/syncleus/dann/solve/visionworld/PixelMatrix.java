...
public interface PixelMatrix {
     ...
     * <code>getWidth() x getHeight()</code> if necessary. The image will not be
     * null.
     *
     ...
     * @throws UnsupportedOperationException if the <code>setPixel</code>
     *             operation is not supported by this pixel matrix
     * @throws ArrayIndexOutOfBoundsException if either of the specified
     *             coordinates are outside the bounds of this pixel matrix
     */
     ...
     * field. The image will not be null.
     *
     * @param receptiveField receptive field through which to view this pixel
     *            matrix, must not be null
     * @return an image for the specified receptive field
     */
    // todo: using BufferedImage may be inappropriate here, maybe a
    // DoubleMatrix2D instead?
