...
public class SVMSearchTrain extends AbstractTraining {
     ...
     */
    public SVMSearchTrain(final SVM method, final Dataset training) {
    ...
    /**
     * @param theConstBegin the constBegin to set
     */
    ...
    /**
     * @param theConstEnd the constEnd to set
     */
    ...
    /**
     * @param theConstStep the constStep to set
     */
    ...
    /**
     * @param theGammaBegin the gammaBegin to set
     */
    ...
    /**
     * @param theGammaEnd the gammaEnd to set.
     */
    ...
    /**
     * @param theGammaStep the gammaStep to set
     */
    ...
    private void setup() {
        ...
        if (this.currentGamma <= 0
                || this.currentGamma < EncogMath.DEFAULT_EPSILON) {
            throw new RuntimeException(
                    "SVM search training cannot use a gamma value less than zero.");
        }

        if (this.currentConst <= 0
                || this.currentConst < EncogMath.DEFAULT_EPSILON) {
            throw new RuntimeException(
     ...
     */
    public void setBestConst(final double bestConst) {
     ...
     */
    public void setBestGamma(final double bestGamma) {
