package syncleus.dann.learn.probability.hmm;
...
public interface HiddenMarkovModel {
	 ...
	 *         sensor model.
	 */
	SimpleRealMatrix getEvidence(List<AssignmentProposition> evidence);
	 ...
	 * @return a new column vector in matrix form with all values set to 1.0.
	 */
	SimpleRealMatrix createUnitMessage();
	 ...
	 *         distribution.
	 */
	SimpleRealMatrix convert(CategoricalDistribution fromCD);
	 ...
	 *         vector.
	 */
	CategoricalDistribution convert(SimpleRealMatrix fromMessage);
	 ...
	 */
	List<CategoricalDistribution> convert(List<SimpleRealMatrix> matrixs);
	 ...
	 */
	SimpleRealMatrix normalize(SimpleRealMatrix m);
}
