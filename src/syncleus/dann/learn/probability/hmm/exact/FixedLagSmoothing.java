package syncleus.dann.learn.probability.hmm.exact;
...
public class FixedLagSmoothing {
	 ...
	 */
	public Matrix forward(SimpleRealMatrix f1_t, Matrix O_tp1) {
