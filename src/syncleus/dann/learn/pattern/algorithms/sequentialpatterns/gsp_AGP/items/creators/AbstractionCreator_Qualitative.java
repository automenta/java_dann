 ...
 */
package syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.creators;
...
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.CandidateInSequenceFinder;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.Item;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.Itemset;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.Sequence;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.abstractions.Abstraction_Generic;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.abstractions.Abstraction_Qualitative;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.abstractions.ItemAbstractionPair;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.patterns.Pattern;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.patterns.PatternCreator;
