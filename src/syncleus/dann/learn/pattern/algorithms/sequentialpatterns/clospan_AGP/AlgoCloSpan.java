package syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP;
/*
...
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.Item;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.PseudoSequence;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.PseudoSequenceDatabase;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.Sequence;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.patterns.Pattern;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.savers.Saver;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.savers.SaverIntoFile;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.savers.SaverIntoMemory;
