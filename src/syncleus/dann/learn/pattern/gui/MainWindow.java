package syncleus.dann.learn.pattern.gui;
/*
...
import syncleus.dann.learn.pattern.algorithms.associationrules.IGB.AlgoIGB;
import syncleus.dann.learn.pattern.algorithms.associationrules.Indirect.AlgoINDIRECT;
import syncleus.dann.learn.pattern.algorithms.associationrules.MNRRules.AlgoMNRRules;
import syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.Database;
import syncleus.dann.learn.pattern.algorithms.associationrules.closedrules.AlgoClosedRules;
import syncleus.dann.learn.pattern.algorithms.associationrules.fhsar.AlgoFHSAR;
import syncleus.dann.learn.pattern.algorithms.clustering.hierarchical_clustering.AlgoHierarchicalClustering;
import syncleus.dann.learn.pattern.algorithms.clustering.kmeans.AlgoKMeans;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.MSApriori.AlgoMSApriori;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori.AlgoApriori;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.aprioriTID.AlgoAprioriTID;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.aprioriTIDClose.AlgoAprioriTIDClose;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori_HT.AlgoAprioriHT;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori_close.AlgoAprioriClose;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori_inverse.AlgoAprioriInverse;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori_rare.AlgoAprioriRare;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.cfpgrowth.AlgoCFPGrowth;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.charm.AlgoCharmMFI;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.charm.AlgoCharm_Bitset;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.charm.AlgoDCharm_Bitset;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.dci_closed_optimized.AlgoDCI_Closed_Optimized;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.defme.AlgoDefMe;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.eclat.AlgoDEclat;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.eclat.AlgoDEclat_Bitset;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.eclat.AlgoEclat;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.eclat.AlgoEclat_Bitset;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.fpgrowth.AlgoFPGrowth;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.hmine.AlgoHMine;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.hui_miner.AlgoFHM;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.hui_miner.AlgoHUIMiner;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.pascal.AlgoPASCAL;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.relim.AlgoRelim;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.two_phase.AlgoTwoPhase;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.uapriori.AlgoUApriori;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.vme.AlgoVME;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.zart.AlgoZart;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.zart.TFTableFrequent;
import syncleus.dann.learn.pattern.algorithms.frequentpatterns.zart.TZTableClosed;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.cmdeogun.AlgoCMDeogun;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.cmrules.AlgoCMRules;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.rulegen.AlgoRuleGen;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.rulegrowth.AlgoRULEGROWTH;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.topseqrules_and_tns.AlgoTNS;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.topseqrules_and_tns.AlgoTopSeqRules;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.trulegrowth.AlgoTRuleGrowth;
import syncleus.dann.learn.pattern.algorithms.sequential_rules.trulegrowth_with_strings.AlgoTRuleGrowth_withStrings;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoBIDEPlus;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoFEAT;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoFSGP;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoPrefixSpan;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan.AlgoTSP_nonClosed;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan_with_strings.AlgoPrefixSpan_with_Strings;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.AlgoCM_ClaSP;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.AlgoClaSP;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.AlgoCloSpan;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoFournierViger08;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoPrefixSpanMDSPM;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.multidimensionalpatterns.AlgoDim;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.multidimensionalsequentialpatterns.AlgoSeqDim;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.multidimensionalsequentialpatterns.MDSequenceDatabase;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.goKrimp.AlgoGoKrimp;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.goKrimp.DataReader;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.AlgoGSP;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.creators.AbstractionCreator;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.creators.AbstractionCreator_Qualitative;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.lapin.AlgoLAPIN_LCI;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.prefixSpan_AGP.AlgoPrefixSpan_AGP;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.AlgoCMSPADE;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.AlgoSPADE;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.candidatePatternsGeneration.CandidateGenerator;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.candidatePatternsGeneration.CandidateGenerator_Qualitative;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.idLists.creators.IdListCreator;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.idLists.creators.IdListCreator_FatBitmap;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spam.AlgoCMSPAM;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spam.AlgoSPAM;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spam.AlgoTKS;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spam.AlgoVGEN;
import syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spam.AlgoVMSP;
import syncleus.dann.learn.pattern.input.sequence_database_list_strings.SequenceDatabase;
import syncleus.dann.learn.pattern.input.transaction_database_list_integers.TransactionDatabase;
import syncleus.dann.learn.pattern.tools.dataset_converter.Formats;
import syncleus.dann.learn.pattern.tools.dataset_converter.SequenceDatabaseConverter;
import syncleus.dann.learn.pattern.tools.dataset_converter.TransactionDatabaseConverter;
import syncleus.dann.learn.pattern.tools.dataset_generator.SequenceDatabaseGenerator;
import syncleus.dann.learn.pattern.tools.dataset_generator.TransactionDatabaseGenerator;
import syncleus.dann.learn.pattern.tools.dataset_stats.SequenceStatsGenerator;
import syncleus.dann.learn.pattern.tools.dataset_stats.TransactionStatsGenerator;
import syncleus.dann.learn.pattern.tools.resultConverter.ResultConverter;
...
public class MainWindow extends JFrame {
    ...
    public static String SPMF_VERSION = "0.96n";
    // current input file
...
//		System.out.println("C" + algorithmName);
        ...
        try {
            ...
            if ("PrefixSpan".equals(algorithmName)) {
                syncleus.dann.learn.pattern.input.sequence_database_list_integers.SequenceDatabase sequenceDatabase = new syncleus.dann.learn.pattern.input.sequence_database_list_integers.SequenceDatabase();
...
//				contextMDDatabase.printContext();
                ...
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.SequenceDatabase database = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.SequenceDatabase();
...
//				contextMDDatabase.printContext();
                ...
                // Apply algorithm
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoBIDEPlus bideplus = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.fournier2008_seqdim.AlgoBIDEPlus(minsup);
...
//				contextMDDatabase.printContext();
                 ...
                 */
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase sd = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.gsp_AGP.items.SequenceDatabase(abstractionCreator);
                ...
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.prefixSpan_AGP.items.creators.AbstractionCreator abstractionCreator = syncleus.dann.learn.pattern.algorithms.sequentialpatterns.prefixSpan_AGP.items.creators.AbstractionCreator_Qualitative.getInstance();
                double minSupport = getParamAsDouble(parameters[0]);
                 ...
                 */
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.prefixSpan_AGP.items.SequenceDatabase sd = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.prefixSpan_AGP.items.SequenceDatabase(abstractionCreator);
                sd.loadFile(inputFile, minSupport);

                algo.runAlgorithm(sd, true, false, outputFile);
                System.out.println(algo.printStatistics());
            }else if ("SPADE".equals(algorithmName)) {
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.creators.AbstractionCreator abstractionCreator = syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.creators.AbstractionCreator_Qualitative.getInstance();
                 ...
                 */
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.database.SequenceDatabase sd = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.dataStructures.database.SequenceDatabase(abstractionCreator, idListCreator);
                sd.loadFile(inputFile, minSupport);
                ...
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.AlgoSPAM_AGP algo = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.spade_spam_AGP.AlgoSPAM_AGP(minSupport);
                ...
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.dataStructures.creators.AbstractionCreator abstractionCreator = syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.dataStructures.creators.AbstractionCreator_Qualitative.getInstance();
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.idlists.creators.IdListCreator idListCreator = syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.idlists.creators.IdListCreatorStandard_Map.getInstance();
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.dataStructures.database.SequenceDatabase sd = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clasp_AGP.dataStructures.database.SequenceDatabase(abstractionCreator, idListCreator);
                ...
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator abstractionCreator = syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.creators.AbstractionCreator_Qualitative.getInstance();
                 ...
                 */
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase sd = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.clospan_AGP.items.SequenceDatabase();
                sd.loadFile(inputFile, minSupport);
...
//				sequenceDatabase.print();
                ...
                syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan_with_strings.AlgoBIDEPlus_withStrings algo = new syncleus.dann.learn.pattern.algorithms.sequentialpatterns.BIDE_and_prefixspan_with_strings.AlgoBIDEPlus_withStrings();
                algo.runAlgorithm(sequenceDatabase, outputFile, minsup);
                algo.printStatistics(sequenceDatabase.size());
                ...
                syncleus.dann.learn.pattern.input.sequence_database_array_integers.SequenceDatabase sequenceDatabase = new syncleus.dann.learn.pattern.input.sequence_database_array_integers.SequenceDatabase();
                sequenceDatabase.loadFile(inputFile);
                ...
                syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.AlgoTopKRules algo = new syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.AlgoTopKRules();
                algo.runAlgorithm(k, minconf, database);
                algo.printStats();
                algo.writeResultTofile(outputFile);   // to save results to file
            } else if ("TNR".equals(algorithmName)) {
                syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.Database database = new syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.Database();
                database.loadFile(inputFile);
                ...
                syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.AlgoTNR algo = new syncleus.dann.learn.pattern.algorithms.associationrules.TopKRules_and_TNR.AlgoTNR();
                algo.runAlgorithm(k, minconf, database, delta);
                algo.printStats();
                algo.writeResultTofile(outputFile);   // to save results to file
            } else if ("TNS".equals(algorithmName)) {
                // Load database into memory
                syncleus.dann.learn.pattern.input.sequence_database_array_integers.SequenceDatabase database = new syncleus.dann.learn.pattern.input.sequence_database_array_integers.SequenceDatabase();
                database.loadFile(inputFile);
                ...
                double minsup = getParamAsDouble(parameters[0]);
                syncleus.dann.learn.pattern.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth_Strings algo = new syncleus.dann.learn.pattern.algorithms.frequentpatterns.fpgrowth_with_strings.AlgoFPGrowth_Strings();
                algo.runAlgorithm(inputFile, outputFile, minsup);
                algo.printStats();
                ...
                syncleus.dann.learn.pattern.patterns.itemset_array_integers_with_count.Itemsets patterns = apriori.runAlgorithm(minsup, inputFile, null);
                apriori.printStats();
                ...
                syncleus.dann.learn.pattern.algorithms.associationrules.agrawal94_association_rules.AlgoAgrawalFaster94 algoAgrawal = new syncleus.dann.learn.pattern.algorithms.associationrules.agrawal94_association_rules.AlgoAgrawalFaster94();
                ...
                syncleus.dann.learn.pattern.patterns.itemset_array_integers_with_count.Itemsets patterns = apriori.runAlgorithm(minsup, maxsup, inputFile, null);
                apriori.printStats();
                int databaseSize = apriori.getDatabaseSize();
...
//				database.printDatabase();
                ...
                syncleus.dann.learn.pattern.patterns.itemset_array_integers_with_tids_bitset.Itemsets patterns = algo.runAlgorithm(null, database, minsup, true, 10000);
                algo.printStats();
                ...
                syncleus.dann.learn.pattern.algorithms.frequentpatterns.fpgrowth.AlgoFPGrowth fpgrowth = new syncleus.dann.learn.pattern.algorithms.frequentpatterns.fpgrowth.AlgoFPGrowth();
                syncleus.dann.learn.pattern.patterns.itemset_array_integers_with_count.Itemsets patterns = fpgrowth.runAlgorithm(inputFile, null, minsup);
                fpgrowth.printStats();
                ...
                syncleus.dann.learn.pattern.patterns.itemset_array_integers_with_count.Itemsets patterns = cfpgrowth.runAlgorithm(inputFile, null, misFileFullPath);
...
//                algo.printStats();
                ...
                syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori.AlgoApriori apriori = new syncleus.dann.learn.pattern.algorithms.frequentpatterns.apriori.AlgoApriori();
                ...
                syncleus.dann.learn.pattern.algorithms.frequentpatterns.uapriori.UncertainTransactionDatabase context = new syncleus.dann.learn.pattern.algorithms.frequentpatterns.uapriori.UncertainTransactionDatabase();
...
//				database.printDatabase();
                ...
                syncleus.dann.learn.pattern.algorithms.frequentpatterns.two_phase.UtilityTransactionDatabaseTP database = new syncleus.dann.learn.pattern.algorithms.frequentpatterns.two_phase.UtilityTransactionDatabaseTP();
                database.loadFile(inputFile);

                // Applying the Two-Phase algorithm
                AlgoTwoPhase twoPhase = new AlgoTwoPhase();
                syncleus.dann.learn.pattern.algorithms.frequentpatterns.two_phase.ItemsetsTP highUtilityItemsets = twoPhase.runAlgorithm(database, minutil);
