 ...
 * interface.
 */
public abstract class AbstractLearning implements Learning, ParameterizedLearning, Serializable {
    ...
    public void setProperty(final String name, final double d) {
        this.properties.put(name,
                CSVFormat.EG_FORMAT.format(d, EncogMath.DEFAULT_PRECISION));
        updateProperties();
    }
    ...
    public void setProperty(final String name, final long l) {
        this.properties.put(name, String.valueOf(l));
        updateProperties();
    }
