 ...
 */
package syncleus.dann.learn.anneal;
...
public abstract class SimulatedAnnealing<UNIT_TYPE> {
    ...
    /**
     * @param theCycles the cycles to set
     */
     ...
     * Should the score be minimized.
     *
     * @param theShouldMinimize True if the score should be minimized.
     */
    ...
    /**
     * @param theStartTemperature the startTemperature to set
     */
    ...
    /**
     * @param theStopTemperature the stopTemperature to set
     */
    ...
    /**
     * @param theTemperature the temperature to set
     */
