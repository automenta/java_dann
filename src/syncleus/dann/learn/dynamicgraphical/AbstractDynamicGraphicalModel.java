...
public abstract class AbstractDynamicGraphicalModel<N extends DynamicGraphicalModelNode, E extends BidirectedEdge<N>>
    ...
    protected AbstractDynamicGraphicalModel(final Set<N> nodes,
                                            final Set<E> edges) {
        super(nodes, edges);
    }
    ...
    public void learnStates(final boolean updateHistory) {
        this.getNodes().stream().forEach((node) -> node.learnState(updateHistory));
    }
    ...
    @Override
    public AbstractDynamicGraphicalModel<N, E> cloneAdd(final Set<N> newNodes,
                                                        final Set<E> newEdges) {
        return (AbstractDynamicGraphicalModel<N, E>) super.cloneAdd(newNodes,
                newEdges);
    }

    @Override
    public AbstractDynamicGraphicalModel<N, E> cloneRemove(final E edgeToRemove) {
        return (AbstractDynamicGraphicalModel<N, E>) super
    ...
    @Override
    public AbstractDynamicGraphicalModel<N, E> cloneRemove(
            final Set<N> deleteNodes, final Set<E> deleteEdges) {
        return (AbstractDynamicGraphicalModel<N, E>) super.cloneRemove(
