package syncleus.dann.logic.propositional.parsing.ast;
...
public abstract class Sentence implements ParseTreeNode {
	...
	public static Sentence newDisjunction(List<? extends Sentence> disjuncts) {
		...
		return new ComplexSentence(AimaUtil.first(disjuncts), Connective.OR, newDisjunction(AimaUtil.rest(disjuncts)));		
	}
	...
	public static Sentence newConjunction(List<? extends Sentence> conjuncts) {
		...
		return new ComplexSentence(AimaUtil.first(conjuncts), Connective.AND, newConjunction(AimaUtil.rest(conjuncts)));		
	}
