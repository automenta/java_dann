...
import static syncleus.dann.logic.epl.ValueType.booleanType;
import static syncleus.dann.logic.epl.ValueType.enumType;
import static syncleus.dann.logic.epl.ValueType.floatingType;
import static syncleus.dann.logic.epl.ValueType.intType;
import static syncleus.dann.logic.epl.ValueType.stringType;
import syncleus.dann.logic.epl.FunctionFactory;
...
import syncleus.dann.logic.io.common.ParseCommonExpression;
import syncleus.dann.logic.io.common.RenderCommonExpression;
import syncleus.dann.logic.io.epl.ParseEPL;
import syncleus.dann.logic.io.epl.RenderEPL;
import syncleus.dann.logic.io.rpn.RenderRPN;
...
public class EncogProgram extends BasicGenome implements RegressionLearning, ErrorLearning {
     ...
     *
     * @param str The program expression.
     ...
     *
     * @param str The program expression value.
     * @return The value the expression was evaluated to.
     */
     ...
     *
     * @param theContext   The context.
     * @param theVariables The variable holder.
     */
    public EncogProgram(final EncogProgramContext theContext,
        ...
        this.context.getDefinedVariables().stream().forEach(this.variables::defineVariable);
    }
     ...
     *
     * @param index The index being sought.
     ...
     * @param replaceWith     The node that is replacing that node.
     */
     ...
     * @param desiredTypes The desired types that the variable can be.
     ...
     *
     * @param theRootNode The new root node.
     */
