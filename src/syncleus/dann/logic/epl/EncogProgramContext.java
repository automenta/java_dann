...
public class EncogProgramContext implements Serializable {
     ...
     * @param theFunctions The function factory.
     */
     ...
     *
     * @param targetProgram The program that this branch will be "grafted" into.
     ...
     *
     * @param expression The common expression to compile.
     ...
     *
     * @param theName The variable name to define.
     */
     ...
     *
     * @param theName           The name of the variable.
     * @param theVariableType   The type of variable.
     * @param theEnumType       The enum type, not used if not an enum type.
     * @param theEnumValueCount The number of values for the enum, not used if not an enum
     *                          type.
     */
    public void defineVariable(final String theName,
     ...
     *
     * @param desiredTypes The types to look for.
    ...
    public List<VariableMapping> findVariablesByTypes(
        ...
        this.definedVariables.stream().filter((mapping) -> (desiredTypes.contains(mapping.getVariableType()))).forEach(result::add);
    ...
    public boolean hasEnum() {
        ...
        return this.definedVariables.stream().anyMatch((mapping) -> (mapping.getVariableType() == ValueType.enumType));
