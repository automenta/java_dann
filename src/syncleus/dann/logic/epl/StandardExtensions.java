...
public class StandardExtensions {
    ...
    public static ProgramExtensionTemplate EXTENSION_VAR_SUPPORT = new BasicTemplate(
        ...
        public boolean isPossibleReturnType(final EncogProgramContext context,
            ...
            return context.getDefinedVariables().stream().anyMatch((mapping) -> (mapping.getVariableType() == rtn));
        }
        ...
        public void randomize(final Random rnd,
            ...
            final int variableIndex = actual.getOwner().selectRandomVariable(
                    rnd, desiredTypes);
            if (variableIndex == -1) {
                throw new RuntimeException("Can't find any variables of type "
    ...
    public static void createAll(final EncogProgramContext context) {
        ...
        EncogOpcodeRegistry.INSTANCE
                .findAllOpcodes().stream().forEach(factory::addExtension);
    }
     ...
     *
     * @param context      The context to add the opcodes to.
     * @param protectedDiv Should protected division be used.
     */
