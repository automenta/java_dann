 ...
 * @since 2.0
 */
public interface DirectedGraph<N, E extends DirectedEdge<N>> extends
        BidirectedGraph<N, E> {
    // we need this for the optimizer and utility class operations. We might
    // also want to fill it in later.
}
