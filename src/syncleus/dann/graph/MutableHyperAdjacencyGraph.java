...
public class MutableHyperAdjacencyGraph<N, E extends HyperEdge<N>> extends
    ...
    @Override
    public MutableHyperAdjacencyGraph<N, E> cloneAdd(final Set<N> newNodes,
                                                     final Set<E> newEdges) {
        return (MutableHyperAdjacencyGraph<N, E>) super.cloneAdd(newNodes,
                newEdges);
    }

    @Override
    public MutableHyperAdjacencyGraph<N, E> cloneRemove(final E edgeToRemove) {
        return (MutableHyperAdjacencyGraph<N, E>) super
    ...
    @Override
    public MutableHyperAdjacencyGraph<N, E> cloneRemove(
            final Set<N> deleteNodes, final Set<E> deleteEdges) {
        return (MutableHyperAdjacencyGraph<N, E>) super.cloneRemove(
