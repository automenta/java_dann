 ...
 */
package syncleus.dann.neural.rbf.training;
 ...
 */
public class SVD {
    public static double svdfit(final double[][] x, final double[][] y,
                                final double[][] a, final RadialBasisFunction[] funcs) {
        int i, j, k;
        double wmax, tmp, thresh, sum;
        final double TOL = 1e-13;

        // Allocated memory for svd matrices
        final double[][] u = new double[x.length][funcs.length];
        final double[][] v = new double[funcs.length][funcs.length];
        final double[] w = new double[funcs.length];
    ...
    public static void svdbksb(final double[][] u, final double[] w,
                               final double[][] v, final double[][] b, final double[][] x) {
        int jj, j, i, m, n, k;
        double s;
    ...
    // / <param name="w"></param>
    // / <param name="v"></param>
    public static void svdcmp(final double[][] a, final double[] w,
                              final double[][] v) {
        boolean flag;
