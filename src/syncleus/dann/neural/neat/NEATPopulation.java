...
public class NEATPopulation extends BasicPopulation implements Serializable,
     ...
     */
    private static final double weightRange = 5;
     ...
     *
     * @param theSubstrate   The substrate ID.
    ...
    public NEATPopulation(final Substrate theSubstrate, final int populationSize) {
        ...
        this.inputCount = 6;
        this.outputCount = 2;
        HyperNEATGenome.buildCPPNEncogActivationFunctions(this.activationFunctions);
    }
     ...
     */
    public ChooseObject<EncogActivationFunction> getEncogActivationFunctions() {
     ...
     */
    public void setNEATEncogActivationFunction(final EncogActivationFunction af) {
