...
public class NEATNetwork implements RegressionLearning, ErrorLearning, Serializable {
     ...
     */
    private final EncogActivationFunction[] activationFunctions;
    ...
    public NEATNetwork(final int inputNeuronCount, final int outputNeuronCount,
                       ...
                       final EncogActivationFunction[] theEncogActivationFunctions) {
        this.links = new NEATLink[connectionArray.size()];
        for (int i = 0; i < connectionArray.size(); i++) {
            this.links[i] = connectionArray.get(i);
        }

        this.activationFunctions = theEncogActivationFunctions;
