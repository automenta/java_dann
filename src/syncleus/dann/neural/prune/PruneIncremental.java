...
public class PruneIncremental extends ConcurrentJob {
     ...
     * @param pattern       The network pattern to use to solve this data.
     * @param iterations    How many iterations to try per network.
     * @param weightTries   The number of random weights to use.
     * @param numTopResults The number of "top networks" to choose the most simple "best
     *                      network" from.
