 ...
 */
package syncleus.dann.neural.prune;
...
public class PruneSelective {
     ...
     *
     * @param targetLayer The layer to increase.
     * @param neuronCount The new neuron count.
     */
     ...
     * bias neuron.
     *
     * @param targetLayer The neuron to prune. Zero specifies the first neuron.
     * @param neuron      The neuron to prune.
     */
     ...
     *
     * @param percent     The percent to randomize by.
     * @param targetLayer The layer that the neuron is on.
     * @param neuron      The neuron to randomize.
     */
     ...
     *
     * @param layer   The layer to stimulate.
     * @param count   The number of weak neurons to stimulate.
     * @param percent The percent to stimulate by.
     */
