...
public class HopfieldNetwork extends ThermalNetwork {
    ...
    public void addPattern(final Data pattern) {
        ...
        final SimpleRealMatrix identity = MatrixMath.identity(m3.getRows());

        // subtract the identity matrix
        final SimpleRealMatrix m4 = MatrixMath.subtract(m3, identity);
     ...
     */
    @Override
    public BiPolarNeuralData compute(final Data input) {
     ...
     */
    private void convertHopfieldMatrix(final SimpleRealMatrix delta) {
