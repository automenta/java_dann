...
//            //return e nextDouble(DEFAULT_RANDOM_STREAM, lambda);
//        }
//
//        @Override
...
//
//        @Override
//        public RealDistribution getBestFit(double[] observations, int numObs) {                                return ExponentialDist.getInstanceFromMLE(observations, numObs);
//        }
//
//        @Override
//        public double[] getBestFitParams(double[] observations, int numObs) {
...
//    },
    ...
    //public abstract RealDistribution getBestFit(double[] observations, int numObs);
