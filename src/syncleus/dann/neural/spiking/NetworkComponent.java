...
public final class NetworkComponent extends WorkspaceComponent {
    ...
    private SpikingNeuralNetwork network = new SpikingNeuralNetwork();
     ...
     * Create a new network component.
     */
    public NetworkComponent(final String name, final SpikingNeuralNetwork network) {
        super(name);
    ...
    private void init() {
        ...
        network.addNeuronListener(new NeuronListener() {
             ...
             * {@inheritDoc}
             */
            public void neuronAdded(NetworkEvent<SpikingNeuron> e) {
             ...
             * {@inheritDoc}
             */
            public void neuronMoved(NetworkEvent<SpikingNeuron> e) {
                setChangedSinceLastSave(true);
            }
             ...
             * {@inheritDoc}
             */
            public void neuronRemoved(NetworkEvent<SpikingNeuron> e) {
                setChangedSinceLastSave(true);
                firePotentialAttributesChanged();
            ...
            @Override
            public void neuronChanged(NetworkEvent<SpikingNeuron> e) {
                setChangedSinceLastSave(true);
            }

            @Override
            public void labelChanged(NetworkEvent<SpikingNeuron> e) {
                setChangedSinceLastSave(true);
            }
        });
    ...
    public static PotentialConsumer getNeuronConsumer(
            NetworkComponent component, SpikingNeuron neuron) {
    ...
    public List<PotentialConsumer> getPotentialConsumers() {
        ...
        for (AttributeType type : getVisibleConsumerTypes()) {
            if (type.getTypeName().equalsIgnoreCase("Neuron")) {
                for (SpikingNeuron neuron : network.getFlatNeuronList()) {
    ...
    public String getKeyFromObject(Object object) {
        if (object instanceof SpikingNeuron) {
            return ((SpikingNeuron) object).getId();
    ...
    public static NetworkComponent open(final InputStream input,
        ...
        SpikingNeuralNetwork newNetwork = (SpikingNeuralNetwork) SpikingNeuralNetwork.getXStream().fromXML(input);
        return new NetworkComponent(name, newNetwork);
    }

    @Override
    public void save(final OutputStream output, final String format) {
        SpikingNeuralNetwork.getXStream().toXML(network, output);
    }
    ...
    public String getXML() {
        return SpikingNeuralNetwork.getXStream().toXML(network);
    }
