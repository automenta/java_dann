...
import syncleus.dann.neural.spiking.neuron_update_rules.PointNeuronRule;
...
public class KWTA extends NeuronGroup {
     ...
     */
    public KWTA(final SpikingNeuralNetwork root, final int k) {
        super(root);
        for (int i = 0; i < k; i++) {
            addNeuron(new SpikingNeuron(getParentNetwork(), new PointNeuronRule()));
        }
     ...
     */
    class PointNeuronComparator implements Comparator<SpikingNeuron> {
