...
public class WinnerTakeAll extends NeuronGroup {
     ...
     */
    public WinnerTakeAll(SpikingNeuralNetwork newRoot, WinnerTakeAll oldNet) {
     ...
     */
    public WinnerTakeAll(final SpikingNeuralNetwork root, final int numNeurons) {
        super(root);
        for (int i = 0; i < numNeurons; i++) {
            // TODO: Prevent invalid states like this?
            this.addNeuron(new SpikingNeuron(root, new LinearRule()));
        }
        setLabel("Winner take all network");
    }
