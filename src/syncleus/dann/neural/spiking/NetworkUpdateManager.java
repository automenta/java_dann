...
import syncleus.dann.neural.spiking.update_actions.BufferedUpdate;
import syncleus.dann.neural.spiking.update_actions.CustomUpdate;
import syncleus.dann.neural.spiking.update_actions.PriorityUpdate;
import syncleus.dann.neural.spiking.update_actions.UpdateGroup;
...
public class NetworkUpdateManager {
    ...
    private final SpikingNeuralNetwork network;
     ...
     * @param network
     */
    public NetworkUpdateManager(SpikingNeuralNetwork network) {
