...
public class SpikingSynapse {
     ...
     */
    private SpikingNeuralNetwork parentNetwork;

    /** Neuron activation will come from. */
    private SpikingNeuron source;

    /** Neuron to which the synapse is attached. */
    private SpikingNeuron target;
     ...
     */
    public SpikingNeuron getSource() {
        return source;
    }
     ...
     * @param target
     */
    private void setSourceAndTarget(final SpikingNeuron source, final SpikingNeuron target) {
        if (this.source != null) {
     ...
     */
    public SpikingNeuron getTarget() {
        return target;
    }
