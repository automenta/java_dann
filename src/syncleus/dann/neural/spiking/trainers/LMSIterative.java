...
public class LMSIterative extends IterableTrainer {
    ...
    public void apply() {
        ...
        for (int row = 0; row < numRows; row++) {
            ...
            // Update output node
            SpikingNeuralNetwork.updateNeurons(network.getOutputNeurons());

            // Iterate through weights and biases and update them
            for (int i = 0; i < numOutputs; i++) {

                // Get target neuron and compute error
                SpikingNeuron outputNeuron = network.getOutputNeurons().get(i);
    ...
    public void randomize() {
        for (SpikingNeuron neuron : network.getOutputNeurons()) {
