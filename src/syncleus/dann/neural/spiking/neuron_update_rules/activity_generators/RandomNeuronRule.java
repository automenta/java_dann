 ...
 */
package syncleus.dann.neural.spiking.neuron_update_rules.activity_generators;
 ...
 */
public class RandomNeuronRule extends SpikingNeuronUpdateRule implements
    ...
    public RandomNeuronRule(SpikingNeuron n) {
        super();
        init(n);
    ...
    public RandomNeuronRule(RandomNeuronRule rn, SpikingNeuron n) {
        super();
        init(n);
