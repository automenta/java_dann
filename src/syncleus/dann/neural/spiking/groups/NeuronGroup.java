...
public class NeuronGroup extends Group {
    ...
    private List<SpikingNeuron> neuronList = new ArrayList<SpikingNeuron>(500);
     ...
     *            the neurons
     */
    public NeuronGroup(final SpikingNeuralNetwork net, final List<SpikingNeuron> neurons) {
        super(net);
        neuronList = new ArrayList<SpikingNeuron>(neurons.size());
        for (SpikingNeuron neuron : neurons) {
            addNeuron(neuron);
        }
        neuronList = new CopyOnWriteArrayList<SpikingNeuron>(neuronList);
    }
     ...
     */
    public NeuronGroup(final SpikingNeuralNetwork net, final int numNeurons) {
     ...
     *            how many neurons it will have
     */
    public NeuronGroup(final SpikingNeuralNetwork net, Point2D initialPosition,
        final int numNeurons) {
        super(net);
        neuronList = new ArrayList<SpikingNeuron>(numNeurons);
        for (int i = 0; i < numNeurons; i++) {
            addNeuron(new SpikingNeuron(net), false);
        }
        neuronList = new CopyOnWriteArrayList<SpikingNeuron>(neuronList);
     ...
     */
    public NeuronGroup(final SpikingNeuralNetwork network, Point2D initialPosition) {
        super(network);
        layout.setInitialLocation(initialPosition);
    }
     ...
     *            parent network
     */
    public NeuronGroup(final SpikingNeuralNetwork network) {
        super(network);
    }
     ...
     */
    public NeuronGroup(final SpikingNeuralNetwork network, final NeuronGroup toCopy) {
        super(network);
        for (SpikingNeuron neuron : toCopy.getNeuronList()) {
            this.addNeuron(new SpikingNeuron(network, neuron));
        }
    }
    ...
    @Override
    public void update() {
        SpikingNeuralNetwork.updateNeurons(neuronList);
    }

    /**
     * @return the neurons in this group.
     */
    public List<SpikingNeuron> getNeuronList() {
     ...
     */
    public void addNeuron(SpikingNeuron neuron, boolean fireEvent) {
     ...
     *            neuron to add
     */
    public void addNeuron(SpikingNeuron neuron) {
     ...
     */
    public void removeNeuron(SpikingNeuron toDelete) {
    ...
    public String toString() {
        ...
        ret += ("Neuron Group [" + getClass().getSimpleName() + "] Neuron group with "
     ...
     */
    public boolean containsNeuron(final SpikingNeuron n) {
    ...
    public void applyInputs() {
        for (SpikingNeuron neuron : getNeuronList()) {
