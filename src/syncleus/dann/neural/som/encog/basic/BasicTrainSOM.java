 ...
 * @author jheaton
 */
public class BasicTrainSOM<D extends Data> extends AbstractTraining<D> implements LearningRate, Function<SOMInput<D>,Data> {
     ...
     */
    private final SOMEncog<D> network;
     ...
     */
    private final SimpleRealMatrix correctionMatrix;
     ...
     */
    public BasicTrainSOM(final SOMEncog network, final double learningRate,
     ...
     * neurons.
     *
     * @param won              An array that specifies how many times each output neuron has
     *                         "won".
     * @param leastRepresented The training pattern that is the least represented by this
     *                         neural network.
     * @param matrix           The synapse to modify.
     * @return True if a winner was forced.
     */
    private boolean forceWinners(final SimpleRealMatrix matrix, final int[] won,
                                 final D leastRepresented) {
     ...
     *
     * @param plannedIterations The number of iterations that are planned. This allows the
     ...
     * info.
     *
     * @param forceWinner True if a winner is to be forced.
     */
    ...
    public static class SOMInput<D extends Data> {
        ...
        public SOMInput(SOMEncog<D> som, D input) {
            this.som = som;
            this.input = input;
        }
    ...
    @Override
    public Data apply(SOMInput<D> s) {
     ...
     */
    private Data compute(final SOMEncog som, final D input) {
