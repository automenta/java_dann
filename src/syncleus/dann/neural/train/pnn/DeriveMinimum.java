 ...
 */
package syncleus.dann.neural.train.pnn;
...
public class DeriveMinimum {
     ...
     * @param maxError      Stop at this error rate.
     * @param eps           The machine's precision.
     * @param tol           The convergence tolerance.
     * @param network       The network to get the error from.
     * @param n             The number of variables.
     * @param x             The independent variable.
     * @param ystart        The start for y.
     * @param base          Work vector, must have n elements.
     * @param direc         Work vector, must have n elements.
     * @param g             Work vector, must have n elements.
     * @param h             Work vector, must have n elements.
     * @param deriv2        Work vector, must have n elements.
    ...
    public double calculate(final int maxIterations, final double maxError,
                            ...
                            final CalculationCriteria network, final int n, final double[] x,
                            final double ystart, final double[] base, final double[] direc,
                            final double[] g, final double[] h, final double[] deriv2) {
        ...
        for (int iteration = 0; iteration < maxIterations; iteration++) {
            ...
            if (Math.abs(dot2) < EncogMath.DEFAULT_EPSILON) {
                scale = 0;
            } else {
                scale = dot1 / dot2;
            }
     ...
     * @param g    The "g" value, used for CJ algorithm.
