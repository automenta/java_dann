...
public class GlobalMinimumSearch {
     ...
     */
    public double brentmin(final int maxIterations, final double maxError,
     ...
     *
     * @param low            The low gamma to begin the search with.
     * @param high           The high gamma to end the search with.
     * @param numberOfPoints The number of points between the low and high. Set this value
     *                       to negative to prevent the first point from being calculated.
     *                       If you do set this to negative, set x2 and y2 to the correct
     *                       values.
     * @param useLog         Should we progress "logarithmically" from low to high.
     * @param minError       We are done if the error is below this.
    ...
    /**
     * @param x1 Set X1, which is a gamma to the left(lower) of the
     *           best(middle) gamma.
     */
    ...
    /**
     * @param x3 Set X3, which is a gamma to the right(higher) of the
     *           middle(best) gamma.
     */
    ...
    /**
     * @param y2 Set Y2, which is the value y2 is the error for x2. This is the
     *           best(middle) error.
     */
