 ...
 */
package syncleus.dann.neural.train.propagation.resilient;
...
public class ResilientPropagation extends Propagation {
    ...
    private final double[] lastWeightChange;
     ...
     * @param initialUpdate The initial update values, this is the amount that the deltas
     ...
     * @param t The type.
     */
    public void setRPROPType(final RPROPType t) {
        this.rpropType = t;
    }
    ...
    public double updateWeightPlus(final double[] gradients,
        ...
        final int change = EncogMath.sign(gradients[index]
                * lastGradient[index]);
        double weightChange = 0;
