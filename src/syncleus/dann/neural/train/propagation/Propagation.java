 ...
 */
package syncleus.dann.neural.train.propagation;
...
import syncleus.dann.neural.train.BatchSize;
...
//    }
     ...
     */
    public void fixFlatSpot(final boolean b) {
        this.shouldFixFlatSpot = b;
    }

    public void setErrorFunction(final ErrorFunction ef) {
        this.ef = ef;
    }
...
//    }
     ...
     */
    public abstract void setBatchSize(int theBatchSize);
