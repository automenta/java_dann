 ...
 */
package syncleus.dann.neural.networks.training.concurrent;
...
public final class ConcurrentTrainingManager implements Runnable {
     ...
     * Add a training job.
     *
     * @param job The training job to add.
     */
     ...
     * do not create another CPU performer.
     *
     * @param splitCores True, if a CPU performer should be created for each core.
     */
