 ...
 */
package syncleus.dann.neural.networks.training.propagation.back;
...
public class Backpropagation extends Propagation implements Momentum,
     ...
     * @param theLearnRate The rate at which the weight matrix will be adjusted based on
     *                     learning.
     * @param theMomentum  The influence that previous iteration's training deltas will
