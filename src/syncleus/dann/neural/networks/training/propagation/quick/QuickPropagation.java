 ...
 */
package syncleus.dann.neural.networks.training.propagation.quick;
...
public class QuickPropagation extends Propagation implements LearningRate {
     ...
     */
    private static final double decay = 0.0001d;
     ...
     * @param network         The network to train.
     * @param training        The training data.
     * @param theLearningRate The learning rate. 2 is a good suggestion as a learning rate
     ...
     */
    public void setShrink(final double s) {
        this.shrink = s;
    }
     ...
     */
    public void setOutputEpsilon(final double theOutputEpsilon) {
     ...
     */
    @Override
    public void setBatchSize(final int theBatchSize) {
        if (theBatchSize != 0) {
            throw new RuntimeException("Online training is not supported for:"
