 ...
 * annealing.
 */
public interface VectorEncodable /*extends Learning*/ {
    ...
    default void encodeToArray(Vector v) {
        encodeToArray(v.getDataRef());
    }
    ...
    default void decodeFromArray(Vector v) {
        decodeFromArray(v.getDataRef());
    }
}
