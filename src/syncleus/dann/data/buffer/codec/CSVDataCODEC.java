...
public class CSVDataCODEC implements DataSetCODEC {
     ...
     */
    private final boolean expectSignificance;

    /**
     * Constructor to create CSV from binary..
     *
     * @param theFile               The CSV file to create.
     * @param theFormat             The format for that CSV file.
     * @param theExpectSignificance True, if a significance column is expected.
     */
     ...
     *
     * @param theFile               The CSV file to load.
     * @param theFormat             The format that the CSV file is in.
     * @param theHeaders            True, if there are headers.
     * @param theInputCount         The number of input columns.
     * @param theIdealCount         The number of ideal columns.
     * @param theExpectSignificance True, if a significance column is expected.
     */
    public CSVDataCODEC(final File theFile, final CSVFormat theFormat,
