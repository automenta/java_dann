...
public final class MatrixMath {
     ...
     */
    public static RealMatrix add(final SimpleRealMatrix a, final SimpleRealMatrix b) {
     ...
     */
    public static RealMatrix deleteCol(final SimpleRealMatrix matrix, final int deleted) {
     ...
     */
    public static RealMatrix deleteRow(final SimpleRealMatrix matrix, final int deleted) {
     ...
     */
    public static RealMatrix divide(final SimpleRealMatrix a, final double b) {
        final double[][] result = new double[a.getRows()][a.getCols()];
     ...
     */
    public static RealMatrix multiply(final SimpleRealMatrix a, final double b) {
        final double[][] result = new double[a.getRows()][a.getCols()];
        final double[][] d = a.getData();
