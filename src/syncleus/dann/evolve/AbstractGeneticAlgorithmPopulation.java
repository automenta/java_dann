...
public abstract class AbstractGeneticAlgorithmPopulation {
     ...
     *
     * @param ourMutationDeviation   The deviation used when mutating each chromosome in the
     *                               population.
    ...
    public final Set<GeneticAlgorithmChromosome> getChromosomes() {
        final Set<GeneticAlgorithmChromosome> chromosomes = this.population.stream().map(AbstractGeneticAlgorithmFitnessFunction::getChromosome).collect(Collectors.toSet());
