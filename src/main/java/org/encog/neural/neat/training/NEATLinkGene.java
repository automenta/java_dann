...
public class NEATLinkGene extends NEATBaseGene implements Serializable {
	...
	public NEATLinkGene(final long fromNeuronID, final long toNeuronID,
			final boolean enabled, final long innovationID, final double weight) {
	...
	public NEATLinkGene(final NEATLinkGene other) {
		copy(other);
	}
	 ...
	 *            The from neuron id.
	 */
	public void setFromNeuronID(final int i) {
		this.fromNeuronID = i;
	}
	 ...
	 *            The to neuron id.
	 */
	public void setToNeuronID(final int i) {
		this.toNeuronID = i;
	}
