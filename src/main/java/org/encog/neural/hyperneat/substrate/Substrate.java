...
public class Substrate implements Serializable {
	 ...
	 * @param theDimensions
	 */
	public Substrate(final int theDimensions) {
	...
	public SubstrateNode createNode() {
		final SubstrateNode result = new SubstrateNode(
				this.currentNeuronNumber++, this.dimensions);
		return result;
	}

	public SubstrateNode createInputNode() {
		final SubstrateNode result = createNode();
	...
	public void createLink(final SubstrateNode inputNode,
			final SubstrateNode outputNode) {
		final SubstrateLink link = new SubstrateLink(inputNode, outputNode);
		this.links.add(link);
	}
	...
	public List<SubstrateNode> getBiasedNodes() {
		final List<SubstrateNode> result = new ArrayList<SubstrateNode>();
