...
public class SpeciesComparator implements Comparator<Species> {
     ...
     * The training method.
     */
    private final EvolutionaryAlgorithm training;
     ...
     */
    public SpeciesComparator(final EvolutionaryAlgorithm theTraining) {
     ...
     */
    @Override
    public int compare(final Species sp1, final Species sp2) {
