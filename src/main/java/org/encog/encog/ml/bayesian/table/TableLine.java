...
public class TableLine implements Serializable {
     ...
     */
    public TableLine(final double prob, final int result, final int[] args) {
     ...
     */
    public boolean compareArgs(final int[] args) {
        ...
        for (int i = 0; i < args.length; i++) {
            if (Math.abs(this.arguments[i] - args[i]) > EncogMath.DEFAULT_EPSILON) {
                return false;
            }
        }
