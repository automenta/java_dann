...
public class PersistBayes implements EncogPersistor {
    ...
    public final void save(final OutputStream os, final Object obj) {
        ...
        String queryType = "";
        final String queryStr = b.getClassificationStructure();
        ...
        for (final BayesianEvent event : b.getEvents()) {
            for (final TableLine line : event.getTable().getLines()) {
                ...
                str.append(BayesianEvent.formatEventName(event,
                        line.getResult()));
                ...
                for (final BayesianEvent parentEvent : event.getParents()) {
                    ...
                    first = false;
                    final int arg = line.getArguments()[index++];
