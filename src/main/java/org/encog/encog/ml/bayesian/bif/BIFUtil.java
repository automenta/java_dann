...
public class BIFUtil {
     ...
     */
    public static BayesianNetwork readBIF(final String f) {
        return readBIF(new File(f));
    }

    public static BayesianNetwork readBIF(final File f) {
     ...
     */
    public static BayesianNetwork readBIF(final InputStream is) {
        try {
     ...
     */
    public static void writeBIF(final String fn, final BayesianNetwork network) {
     ...
     * @param network The network to save.
     */
    public static void writeBIF(final File file, final BayesianNetwork network) {
