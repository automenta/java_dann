...
public class LoadedMarketData implements Comparable<LoadedMarketData> {
    ...
    public static final int INDEX_DOUBLE_HIGH = 0;
    public static final int INDEX_DOUBLE_LOW = 0;
    public static final int INDEX_DOUBLE_OPEN = 0;
    public static final int INDEX_DOUBLE_CLOSE = 0;
     ...
     *
     * @param when   When was this sample taken.
     * @param ticker What is the ticker symbol for this data.
     */
    public LoadedMarketData(final Date when, final TickerSymbol ticker) {
        this.when = when;
        this.ticker = ticker;
        this.data = new EnumMap<>(MarketDataType.class);
    }
     ...
     *
     * @param type The type of data needed.
     ...
     *
     * @param type The type of data being set.
     * @param data The value of the data being set.
     */
