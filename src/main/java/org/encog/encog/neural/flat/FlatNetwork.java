...
public class FlatNetwork implements Serializable, Cloneable {
     ...
     */
    private EncogActivationFunction[] activationFunctions;
     ...
     *
     * @param input   Neurons in the input layer.
     * @param hidden1 Neurons in the first hidden layer. Zero for no first hidden
     *                layer.
     * @param hidden2 Neurons in the second hidden layer. Zero for no second hidden
     *                layer.
     * @param output  Neurons in the output layer.
     * @param tanh    True if this is a tanh activation, false for sigmoid.
     */
    public FlatNetwork(final int input, final int hidden1, final int hidden2,
                       final int output, final boolean tanh) {

        final EncogActivationFunction linearAct = new ActivationLinear();
        FlatLayer[] layers;
        final EncogActivationFunction act = tanh ? new ActivationTANH()
    ...
    public void cloneFlatNetwork(final FlatNetwork result) {
        ...
        result.activationFunctions = new EncogActivationFunction[this.activationFunctions.length];
        for (int i = 0; i < result.activationFunctions.length; i++) {
            result.activationFunctions[i] = (EncogActivationFunction) (this.activationFunctions[i]).clone();
        }
    ...
    protected void computeLayer(final int currentLayer) {
        ...
        this.activationFunctions[currentLayer - 1].activate(
     ...
     */
    public EncogActivationFunction[] getEncogActivationFunctions() {
        return this.activationFunctions;
    }

    public EncogActivationFunction[] getActivationFunctions() {
        return this.activationFunctions;
    }
    ...
    public Class<?> hasSameActivationFunction() {
        ...
        for (final EncogActivationFunction activation : this.activationFunctions) {
     ...
     *
     * @param layers The layers of the network to create.
     */
    public void init(final FlatLayer[] layers) {
        ...
        this.activationFunctions = new EncogActivationFunction[layerCount];
     ...
     */
    public void setEncogActivationFunctions(final EncogActivationFunction[] af) {
     ...
     */
    public void setLayerSums(final double[] d) {
