...
public class FlatLayer {
     ...
     */
    private EncogActivationFunction activation;
     ...
     */
    public FlatLayer(final EncogActivationFunction activation, final int count,
     ...
     */
    public EncogActivationFunction getActivation() {
    ...
    public boolean hasBias() {
        return Math.abs(this.biasActivation) > EncogMath.DEFAULT_EPSILON;
    }

    /**
     * @param activation the activation to set
     */
    public void setActivation(final EncogActivationFunction activation) {
        this.activation = activation;
    }
