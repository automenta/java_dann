...
public class ART1 extends ART implements MLResettable, MLClassification {
     ...
     */
    private SimpleRealMatrix weightsF1toF2;

    /**
     * Weights from f2 to f1.
     */
    private SimpleRealMatrix weightsF2toF1;
     ...
     *
     * @param theF1Count The neuron count for the f1 layer.
     * @param theF2Count The neuron count for the f2 layer.
     */
     ...
     */
    public SimpleRealMatrix getWeightsF1toF2() {
     ...
     */
    public SimpleRealMatrix getWeightsF2toF1() {
     ...
     * Set the vigilance.
     *
     * @param theVigilance The new value.
     */
     ...
     */
    public void setWeightsF1toF2(final SimpleRealMatrix matrix) {
     ...
     * @param matrix The new matrix.
     */
    public void setWeightsF2toF1(final SimpleRealMatrix matrix) {
