...
public class ContinousDistribution implements StateDistribution {
	 ...
	 */
	final private SimpleRealMatrix covariance;
	...
	public double probability(final MLDataPair o) {
		...
		final SimpleRealMatrix vmm = Matrix.createColumnMatrix(EngineArray.subtract(v,
				this.mean));
	...
	public void update(final double[][] covariance) {
		this.cd = new CholeskyDecomposition2(new Matrix(covariance));
	 ...
	 */
	public SimpleRealMatrix getCovariance() {
