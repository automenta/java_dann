...
import syncleus.dann.math.cluster.KMeansUtil;
...
public class KMeansClustering implements MLClustering {
	 ...
	 * The kmeans utility.
	 */
	private final KMeansUtil<BasicMLDataPair> kmeans;
	...
	public KMeansClustering(final int theK, final MLDataSet theSet) {
		final List<BasicMLDataPair> list = new ArrayList<BasicMLDataPair>();
