...
public class ActionNode extends BasicNode {
	...
	public ActionNode(final String label) {
		super(label);
	}

	public ActionNode(final String theName, final double theDuration) {
		super(theName);
	 ...
	 */
	public void setEarliestStartTime(final double earliestStartTime) {
