...
public class EarlyStoppingStrategy implements EndTrainingStrategy {
	 ...
	 * The validation set.
	 */
	private final MLDataSet validationSet;

	/**
	 * The test set.
	 */
	private final MLDataSet testSet;
	 ...
	 *            The test set.
	 */
	public EarlyStoppingStrategy(final MLDataSet theValidationSet,
			final MLDataSet theTestSet) {
	 ...
	 */
	public EarlyStoppingStrategy(final MLDataSet theValidationSet,
			final MLDataSet theTestSet, final int theStripLength,
	 ...
	 */
	@Override
	public void init(final MLTrain theTrain) {
		this.train = theTrain;
