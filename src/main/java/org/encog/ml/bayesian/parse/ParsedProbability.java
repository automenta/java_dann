...
public class ParsedProbability {
	 ...
	 */
	public int[] getArgs(final BayesianNetwork network) {
	 ...
	 */
	public void defineTruthTable(final BayesianNetwork network,
			final double result) {
	 ...
	 *            The network.
	 */
	public void defineRelationships(final BayesianNetwork network) {
