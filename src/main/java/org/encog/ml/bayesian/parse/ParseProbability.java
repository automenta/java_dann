...
public class ParseProbability {
	 ...
	 */
	public ParseProbability(final BayesianNetwork theNetwork) {
	}
	...
	public static List<ParsedProbability> parseProbabilityList(
			final BayesianNetwork network, final String line) {
		final List<ParsedProbability> result = new ArrayList<ParsedProbability>();
