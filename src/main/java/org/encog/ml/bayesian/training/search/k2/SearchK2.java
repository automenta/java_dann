...
public class SearchK2 implements BayesSearch {
	...
	public void init(final TrainBayesian theTrainer,
			final BayesianNetwork theNetwork, final MLDataSet theData) {
	...
	private BayesianEvent findZ(final BayesianEvent event, final int n,
		...
		for (int i = 0; i < n; i++) {
			...
			final List<BayesianEvent> parents = new ArrayList<BayesianEvent>();
	 ...
	 * @return The value N.
	 */
	public int calculateN(final BayesianNetwork network,
	 ...
	 */
	public double calculateG(final BayesianNetwork network,
			final BayesianEvent event, final List<BayesianEvent> parents) {
		double result = 1.0;
