 ...
 *
 * @param <N>
 *            The type of MutableNumber to use as the value.
 * @author Jeffrey Phillips Freeman
 * @since 2.0
 */
public abstract class AbstractValueGene<N extends MutableNumber> implements
		ValueGene<N> {
	private N value;
	private static final Logger LOGGER = LogManager
			.getLogger(AbstractValueGene.class);
	 ...
	 *
	 * @param backingValue
	 *            MutableNumber to back the ValueGene with.
	 * @since 2.0
	 */
	 ...
	 *
	 * @param deviation
	 *            deviation to use during mutation. A higher value represents
