...
public class GeneticAlgorithmChromosome implements
     ...
     *
     * @param geneCount    The number of genes to create in this chromosome.
     * @param maxDeviation The multiplier for the normal distribution of initial values
    ...
    public void crossover(final List<AbstractValueGene> geneticSegment,
        ...
        this.alleles = new ArrayList<>(this.alleles.subList(0,
                point));
    ...
    public GeneticAlgorithmChromosome mutate(final double deviation) {
        ...
        mutated.alleles.addAll(this.alleles.stream().map(allele -> allele.mutate(deviation)).collect(Collectors.toList()));
        return mutated;
    }
