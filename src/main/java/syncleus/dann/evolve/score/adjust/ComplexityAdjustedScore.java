 ...
 */
package syncleus.dann.evolve.score.adjust;
...
public class ComplexityAdjustedScore implements AdjustScore {
     ...
     * @param theComplexityPentaltyFullThreshold The complexity level at which a full (100%) penalty is
     *                                           applied.
     * @param theComplexityPenalty               The starting complexity penalty.
     * @param theComplexityFullPenalty           The full complexity penalty.
     */
    public ComplexityAdjustedScore(final int theComplexityPenaltyThreshold,
                                   final int theComplexityPentaltyFullThreshold,
                                   final double theComplexityPenalty,
                                   final double theComplexityFullPenalty) {
     ...
     */
    @Override
    public double calculateAdjustment(final Genome genome) {
        final double score = genome.getScore();
        double result = 0;

        if (genome.size() > this.complexityPenaltyThreshold) {
            final int over = genome.size() - this.complexityPenaltyThreshold;
            final int range = this.complexityPentaltyFullThreshold
                    - this.complexityPenaltyThreshold;
            final double complexityPenalty = ((this.complexityFullPenalty - this.complexityPenalty) / range)
                    * over;
     ...
     */
    public void setComplexityPenalty(final double complexityPenalty) {
     ...
     */
    public void setComplexityFullPenalty(final double complexityFullPenalty) {
     ...
     */
    public void setComplexityPenaltyThreshold(
            final int complexityPenaltyThreshold) {
    ...
    public void setComplexityPentaltyFullThreshold(
            final int complexityPentaltyFullThreshold) {
