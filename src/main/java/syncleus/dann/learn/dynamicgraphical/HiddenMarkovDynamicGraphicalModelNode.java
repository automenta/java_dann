...
public class HiddenMarkovDynamicGraphicalModelNode<S> extends
		SimpleDynamicGraphicalModelNode<S> {
	public HiddenMarkovDynamicGraphicalModelNode(final S initialState) {
		super(0, initialState);
	}

	public HiddenMarkovDynamicGraphicalModelNode(final S lastState,
