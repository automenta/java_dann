...
public class MutableDynamicGraphicalModelAdjacencyGraph<N extends DynamicGraphicalModelNode, E extends BidirectedEdge<N>>
        extends AbstractDynamicGraphicalModel<N, E> implements
        MutableDynamicGraphicalModel<N, E> {
    ...
    public MutableDynamicGraphicalModelAdjacencyGraph(final Set<N> nodes,
                                                      final Set<E> edges) {
        super(nodes, edges);
    }
    ...
    @Override
    public MutableDynamicGraphicalModelAdjacencyGraph<N, E> cloneAdd(
            final E newEdge) {
        return (MutableDynamicGraphicalModelAdjacencyGraph<N, E>) super
                .cloneAdd(newEdge);
    }
    ...
    public MutableDynamicGraphicalModelAdjacencyGraph<N, E> cloneAdd(
        ...
        return (MutableDynamicGraphicalModelAdjacencyGraph<N, E>) super
                .cloneAdd(newNodes, newEdges);
    }

    @Override
    public MutableDynamicGraphicalModelAdjacencyGraph<N, E> cloneRemove(
