...
public class MutableMarkovRandomFieldAdjacencyGraph<N extends GraphicalModelNode, E extends UndirectedEdge<N>>
        extends AbstractMarkovRandomFieldAdjacencyGraph<N, E> implements
        MutableMarkovRandomField<N, E> {
    ...
    public MutableMarkovRandomFieldAdjacencyGraph(final Set<N> nodes,
                                                  final Set<E> edges) {
        super(nodes, edges);
    }
    ...
    public MutableMarkovRandomFieldAdjacencyGraph<N, E> cloneAdd(final E newEdge) {
        return (MutableMarkovRandomFieldAdjacencyGraph<N, E>) super
                .cloneAdd(newEdge);
    }
    ...
    @Override
    public MutableMarkovRandomFieldAdjacencyGraph<N, E> cloneAdd(
            final Set<N> newNodes, final Set<E> newEdges) {
        return (MutableMarkovRandomFieldAdjacencyGraph<N, E>) super.cloneAdd(
                newNodes, newEdges);
    }

    @Override
    public MutableMarkovRandomFieldAdjacencyGraph<N, E> cloneRemove(
