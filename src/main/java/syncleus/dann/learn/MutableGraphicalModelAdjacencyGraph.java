...
public class MutableGraphicalModelAdjacencyGraph<N extends GraphicalModelNode, E extends BidirectedEdge<N>>
    ...
    public MutableGraphicalModelAdjacencyGraph(final Set<N> nodes,
                                               final Set<E> edges) {
        super(nodes, edges);
    }
    ...
    public MutableGraphicalModelAdjacencyGraph<N, E> cloneAdd(final E newEdge) {
        return (MutableGraphicalModelAdjacencyGraph<N, E>) super
                .cloneAdd(newEdge);
    }
    ...
    @Override
    public MutableGraphicalModelAdjacencyGraph<N, E> cloneAdd(
            final Set<N> newNodes, final Set<E> newEdges) {
        return (MutableGraphicalModelAdjacencyGraph<N, E>) super.cloneAdd(
                newNodes, newEdges);
    }

    @Override
    public MutableGraphicalModelAdjacencyGraph<N, E> cloneRemove(
    ...
    public MutableGraphicalModelAdjacencyGraph<N, E> cloneRemove(
        ...
        return (MutableGraphicalModelAdjacencyGraph<N, E>) super.cloneRemove(
