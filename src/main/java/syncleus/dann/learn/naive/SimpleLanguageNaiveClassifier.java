 ...
 */
public class SimpleLanguageNaiveClassifier<C> extends
     ...
     * @see com.syncleus.dann.classify.naive.SimpleNaiveClassifier#featureClassificationProbability(Object,
     * Object)
     */
    @Override
    ...
    /**
     * Gets the weighted probability that a given feature is in the given
     * category.
     *
     * @param feature  The feature to check
     * @param category The category to check
     * @return The weighted probability that the given feature is in the given
     * category
     * @see com.syncleus.dann.classify.naive.SimpleNaiveClassifier#featureClassificationWeightedProbability(Object,
     * Object)
     */
    @Override
