...
//     */
//    public static EncogBayesianNetwork readBIF(final String f) {
//        return readBIF(new File(f));
//    }
//
//    public static EncogBayesianNetwork readBIF(final File f) {
...
//     */
//    public static EncogBayesianNetwork readBIF(final InputStream is) {
//        try {
//            final BIFHandler h = new BIFHandler();
...
//     *
//     * @param fn      The file name to save to.
//     * @param network The network to save.
//     */
//    public static void writeBIF(final String fn, final EncogBayesianNetwork network) {
...
//     * @param network The network to save.
//     */
//    public static void writeBIF(final File file, final EncogBayesianNetwork network) {
...
//     */
//    public static void writeBIF(final OutputStream os,
//                                final EncogBayesianNetwork network) {
//        final WriteXML xml = new WriteXML(os);
//        xml.beginDocument();
//        xml.addAttribute("VERSION", "0.3");
//        xml.beginTag("BIF");
//        xml.beginTag("NETWORK");
//        xml.addProperty("NAME", "Bayes Network, Generated by Encog");
//        network.getEvents().stream().map((event) -> {
//            xml.addAttribute("TYPE", "nature");
//            xml.beginTag("VARIABLE");
//            xml.addProperty("NAME", event.getLabel());
//            return event;
//        }).map((event) -> {
//            event.getChoices().stream().forEach((str) -> xml.addProperty("OUTCOME", str.getLabel()));
//            return event;
//        }).forEach((_item) -> xml.endTag());
//        network.getEvents().stream().map((event) -> {
//            xml.beginTag("DEFINITION");
//            xml.addProperty("FOR", event.getLabel());
//            return event;
//        }).map((event) -> {
//            event.getParents().stream().forEach((parentEvent) -> xml.addProperty("GIVEN", parentEvent.getLabel()));
//            return event;
//        }).map((event) -> {
...
//     */
//    public static String generateTable(final BayesianEvent event) {
//        final StringBuilder s = new StringBuilder();
//        final int[] args = new int[event.getParents().size()];
//        do {
//            for (int result = 0; result < event.getChoices().size(); result++) {
//                final TableLine line = event.getTable().findLine(result, args);
//                if (s.length() > 0) {
//                    s.append(' ');
//                }
...
//     */
//    public static boolean rollArgs(final BayesianEvent event, final int[] args) {
