...
public class BayesianChoice implements Serializable, Comparable<BayesianChoice> {
     ...
     *
     * @param label The label for this choice.
     * @param min   The minimum value for this range.
     * @param max   The maximum value for this range.
     */
    public BayesianChoice(final String label, final double min, final double max) {
        super();
        this.label = label;
        this.min = min;
        this.max = max;
     ...
     *
     * @param label The label for this choice.
     * @param index The index for this choice.
     */
    public BayesianChoice(final String label, final int index) {
        super();
        this.label = label;
        this.min = index;
        this.max = index;
    ...
    public boolean isIndex() {
        return Math.abs(this.min - this.max) < EncogMath.DEFAULT_EPSILON;
    }
     ...
     */
    @Override
    public int compareTo(final BayesianChoice other) {
