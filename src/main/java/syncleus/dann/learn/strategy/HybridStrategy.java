...
public class HybridStrategy implements Strategy {
     ...
     */
    private Training mainTrain;

    /**
     * The alternate training method.
     */
    private final Training altTrain;
     ...
     */
    public HybridStrategy(final Training altTrain) {
     ...
     * @param tolerateMinImprovement The number of cycles to tolerate the minimum improvement for.
     * @param alternateCycles        How many cycles should the alternate training algorithm be
     *                               used for.
     */
    public HybridStrategy(final Training altTrain, final double minImprovement,
