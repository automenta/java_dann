...
public class RBFNetwork extends BasicML implements MLError, MLRegression,
     ...
     * @param widths  Array containing widths. Row n contains widths for neuron n.
     *                Row n contains x elements for x number of dimensions.
     ...
     * space.
     *
     * @param minPosition          The minimum position neurons should be centered. Typically 0.
     * @param maxPosition          The maximum position neurons should be centered. Typically 1
     * @param volumeNeuronRBFWidth The neuron width of neurons within the mesh.
     * @param useWideEdgeRBFs      Enables wider RBF's around the boundary of the neuron mesh.
     */
