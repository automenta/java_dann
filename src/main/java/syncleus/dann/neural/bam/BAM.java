...
public class BAM extends AbstractLearning {
     ...
     * @param x      The x matrix value. (could be row or column, depending on
     *               input)
     * @param y      The y matrix value. (could be row or column, depending on
     *               input)
     ...
     * Propagate the layer.
     *
     * @param matrix The matrix for this layer.
