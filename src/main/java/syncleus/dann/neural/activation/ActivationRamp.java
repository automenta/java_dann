 ...
 */
public class ActivationRamp implements EncogActivationFunction {
     ...
     * @param high          The high value, replaced if the high threshold is exceeded.
     * @param low           The low value, replaced if the low threshold is exceeded.
     */
