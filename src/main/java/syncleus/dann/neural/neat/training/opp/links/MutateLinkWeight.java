...
public interface MutateLinkWeight {
     ...
     *
     * @param theTrainer The training class that this mutator is used with.
     */
     ...
     * @param linkGene    The link to mutate.
     * @param weightRange The weight range, weights are between -weightRange and
     *                    +weightRange.
     */
