...
public class NEATInnovationList implements Serializable {
     ...
     */
    private final Map<String, NEATInnovation> list = new HashMap<>();
     ...
     */
    public static String produceKeyNeuron(final long id) {
     ...
     * @return The key.
     */
    public static String produceKeyNeuronSplit(final long fromID,
                                               final long toID) {
        final StringBuilder result = new StringBuilder();
        result.append("ns:");
     ...
     */
    public static String produceKeyLink(final long fromID, final long toID) {
        final StringBuilder result = new StringBuilder();
        result.append("l:");
        result.append(fromID);
        result.append(':');
     ...
     *
     * @param fromID The source neuron ID in the link.
     * @param toID   The target neuron ID in the link.
     * @return The newly created innovation, or the one that matched the search.
     */
    public NEATInnovation findInnovationSplit(final long fromID, final long toID) {
        final String key = NEATInnovationList.produceKeyNeuronSplit(fromID,
                toID);
        ...
        synchronized (this.list) {
            if (this.list.containsKey(key)) {
                ...
                final long neuronID = this.population.assignGeneID();
     ...
     *
     * @param neuronID The neuron ID to find.
     * @return The newly created innovation, or the one that matched the search.
     */
    public NEATInnovation findInnovation(final long neuronID) {
        final String key = NEATInnovationList.produceKeyNeuron(neuronID);
     ...
     * @return The newly created innovation, or the one that matched the search.
     */
    public NEATInnovation findInnovation(final long fromID, final long toID) {
        final String key = NEATInnovationList.produceKeyLink(fromID, toID);
     ...
     */
    public void setPopulation(final NEATPopulation population) {
        this.population = population;
    }
