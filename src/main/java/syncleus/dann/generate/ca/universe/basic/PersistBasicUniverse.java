...
//					final double[] d = NumberList.fromList(CSVFormat.EG_FORMAT,
//							line);
//					int idx = 0;
//					for (int col = 0; col < cols; col++) {
//						final UniverseCell cell = result.get(row, col);
...
//		final UniverseCellFactory factory = universe.getCellFactory();
//		final String className = factory.getClass().getSimpleName();
//		out.writeProperty(PersistConst.TYPE, className);
//		if (factory instanceof BasicCellFactory) {
//			final BasicCellFactory factory2 = (BasicCellFactory) factory;
//			out.writeProperty(BasicUniverse.ELEMENT_COUNT,
//					factory2.getElementCount());
...
//		} else {
//			throw new CellularAutomataError("Unknown cell factory: "
//					+ className);
//		}
