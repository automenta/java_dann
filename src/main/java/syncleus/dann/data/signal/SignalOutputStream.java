 ...
 *                                                                             *
 ******************************************************************************/
package syncleus.dann.data.signal;
...
public class SignalOutputStream extends OutputStream {
	...
	/**
	 * Creates a new SignalOutputStream around the provided OutputStream. If
	 * this stream is not an ObjectOutputStream, it wraps the underlying stream
	 * in one.
	 *
	 * @param outputStream
	 *            The OutputStream to use
	 * @throws IOException
	 *             If an IOException occurs in the underlying stream
	 */
	public SignalOutputStream(final OutputStream outputStream)
			throws IOException {
	 ...
	 * @param off
	 *            The offset into the signal array to use
	 * @param len
	 *            The length of the array
	 * @throws IOException
	 *             If a write error occurs
	 */
	public void writeSignal(final double[] signals, final int off, final int len)
			throws IOException {
	 ...
	 *
	 * @throws IOException
	 *             If the stream is already closed, or another error occurs
	 */
	@Override
