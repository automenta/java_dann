...
public class BasicFile /* implements QuantTask*/ {
    ...
    public static void appendSeparator(final StringBuilder line,
        ...
        if ((line.length() > 0)
                && !line.toString().endsWith(String.valueOf(format.getSeparator()))) {
...
//                for (final DataField field : this.getScript().getFields()) {
...
//     *
//     * @param isAnalyzing True if we are analyzing.
//     */
...
//    }
     ...
     *
     * @param theAnalyzed True, if the file has been analyzed.
     */
     ...
     *
     * @param theColumnCount The new column count.
     */
     ...
     *
     * @param theInputFilename The input filename.
     */
     ...
     *
     * @param theInputFormat The new inputFormat format.
     */
     ...
     *
     * @param theInputHeadings The new input headings.
     */
     ...
     *
     * @param thePrecision The precision to use.
     */
    ...
    /**
     * @param theProduceOutputHeaders the produceOutputHeaders to set
     */
     ...
     *
     * @param theReport The status reporting object.
     */
...
//    }
     ...
     *
     * @param theReportInterval The new reporting interval.
     */
...
//     *
//     * @param isAnalyzing True if we are in the process of analyzing.
//     */
...
//     *
//     * @param task The string to report.
//     */
...
//     * @param row The row to write out.
//     */
