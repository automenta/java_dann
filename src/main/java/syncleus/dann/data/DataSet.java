 ...
 * @author jheaton
 */
public interface DataSet<M extends Data> extends Iterable<DataSample<M>> {
     ...
     */
    void getRecord(long index, DataSample<M> s);
     ...
     * methods.
     *
     * @param data1 The data item to be added.
     */
    void add(Data data1);
     ...
     * @param idealData Ideal data.
     */
    void add(Data inputData, Data idealData);
     ...
     * add methods.
     *
     * @param inputData A MLDataPair object that contains both input and ideal data.
     */
    void add(DataSample inputData);
