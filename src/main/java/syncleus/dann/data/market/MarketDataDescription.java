...
public class MarketDataDescription extends TemporalDataDescription {
     ...
     *
     * @param ticker             The ticker symbol to use.
     * @param dataType           The data type needed.
     * @param type               The normalization type.
     * @param activationFunction The activation function to apply to this data, can be null.
     * @param input              Is this field used for input?
     * @param predict            Is this field used for prediction?
     */
