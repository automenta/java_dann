...
public class CSVNeuralDataSet extends VectorDataset {
     ...
     *
     * @param theFilename  The CSV filename to read.
     * @param theInputSize The number of columns that make up the input set. *
     * @param theIdealSize The number of columns that make up the ideal set.
     * @param theHeaders   True if headers are present on the first line.
     */
    public CSVNeuralDataSet(final String theFilename, final int theInputSize,
                            final int theIdealSize, final boolean theHeaders) {
     ...
     * @param theIdealSize The number of columns that make up the ideal set.
     * @param theHeaders   True if headers are present on the first line.
     * @param theFormat    What CSV format to use.
     * @param significance True, if there is a significance column.
     */
    public CSVNeuralDataSet(final String theFilename, final int theInputSize,
                            final int theIdealSize, final boolean theHeaders,
                            final CSVFormat theFormat, final boolean significance) {
