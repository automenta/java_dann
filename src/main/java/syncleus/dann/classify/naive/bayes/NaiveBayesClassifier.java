...
import syncleus.dann.classify.naive.NaiveClassifier;
 ...
 * @param <F>
 *            The type of feature from the item
 * @param <C>
...
public interface NaiveBayesClassifier<I, F, C> extends NaiveClassifier<I, F, C> {
	/**
	 * Gets the classification of an item, possibly using the threshold. If all
	 * possible categories are below the threshold, null is returned.
	 *
	 * @param item
	 *            The item to classify
	 * @param useThreshold
