 ...
 * stems into categories.
 *
 * @param <C>
 *            The categories to classify things into
 * @author Jeffrey Phillips Freeman
 */
public class StemmingLanguageNaiveBayesClassifier<C> extends
	...
	/**
	 * Gets the weighted probability that a given feature is in the supplied
	 * category.
	 *
	 * @param feature
	 *            The feature to check
	 * @param category
	 *            The category to check
	 * @return The weighted probability that a given feature is in the supplied
	 *         category
	 */
	@Override
	...
	/**
	 * A StemmingWordExtractor is a FeatureExtractor that extracts stems from
	 * words.
	 */
