 ...
 * @param <F>
 *            The type of features the item has
 * @param <C>
 *            The type of categories to use
...
public class SimpleNaiveClassifier<I, F, C> implements
	 ...
	 *
	 * @param item
	 *            The item to get probabilities for
	 ...
	 *            The item
	 * @param category
	 *            The category to associate with the item
	 */
	@Override
	 ...
	 *
	 * @param category
	 *            The category to get the probability for
