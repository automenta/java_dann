...
public interface ConnectionismOptimizedGraph<N, E extends Edge<N>> extends
		Graph<N, E> {
	/**
	 ...
	 * getAdjacentEdges().size(). Throws an IllegalArgumentException if node is
	 * not in the graph.
	 *
	 * @param node
	 ...
	 *             thrown if there are no nodes in the graph.
	 * @since 2.0
	 */
