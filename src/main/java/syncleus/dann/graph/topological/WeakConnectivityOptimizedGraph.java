...
public interface WeakConnectivityOptimizedGraph<N, E extends Edge<N>> extends
     ...
     * @throws IllegalArgumentException if either of the specified nodes is not in the graph.
     * @since 2.0
     */
     ...
     * false otherwise.
     * @throws IllegalArgumentException if any of nodes, edges, begin, or end are not in this graph
     ...
     * @throws IllegalArgumentException if either begin or end is not in the graph.
     * @since 2.0
     */
