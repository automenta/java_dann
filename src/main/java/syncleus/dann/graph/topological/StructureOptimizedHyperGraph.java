...
public interface StructureOptimizedHyperGraph<N, E extends HyperEdge<N>>
	 ...
	 *
	 * @param partialGraph
	 *            the graph to check if it is a partial hyper-graph.
	 ...
	 *
	 * @param hostGraph
	 *            the graph to check if it is a host graph.
