...
public final class Topography {
	 ...
	 *
	 * @param subGraph
	 *            A subgraph of this graph to be checked if maximally connected.
	...
	public static <N, E extends Edge<N>> int getNodeConnectivity(
		...
		final Set<Set<N>> combinations = Counters.everyCombination(graph
				.getNodes());
		final SortedSet<Set<N>> sortedCombinations = new TreeSet<Set<N>>(
				new SizeComparator());
	...
	public static <N, E extends Edge<N>> int getEdgeConnectivity(
		...
		final Set<Set<E>> combinations = Counters.everyCombination(graph
				.getEdges());
		final SortedSet<Set<E>> sortedCombinations = new TreeSet<Set<E>>(
				new SizeComparator());
		sortedCombinations.addAll(combinations);
	 ...
	 *             If this graph has no nodes, or the graph is not regular
	 ...
	 *
	 * @param edge
	 *            the edge of which the multiplicity is to be calculated.
	 ...
	 *             if the specified edge is not present in the graph.
	 * @since 2.0
	 * @see com.syncleus.dann.graph.topological.Topography#getMultiplicity(Graph,
	 ...
	 *
	 * @param edge
	 *            the edge to check if it is multiple.
	 ...
	 *
	 * @param knotedNodes
	 *            A set of nodes to check if they form a knot.
	 * @return false
	 * @since 2.0
	 */
	 ...
	 *            The nodes to remove
	 * @param deleteEdges
	 *            The edges to remove in addition to the nodes
