...
public class ImmutableRootedTreeAdjacencyGraph<N, E extends DirectedEdge<N>>
		extends AbstractRootedTreeAdjacencyGraph<N, E> {
	...
	public ImmutableRootedTreeAdjacencyGraph(final Set<N> nodes,
			final Set<E> edges) {
		super(nodes, edges);
	}
	...
	protected Map<N, Set<E>> getInternalAdjacencyEdges() {
		...
		for (final Map.Entry<N, Set<E>> neighborEdgeEntry : super
	...
	protected Map<N, List<N>> getInternalAdjacencyNodes() {
		...
		for (final Map.Entry<N, List<N>> neighborNodeEntry : super
	...
	public ImmutableRootedTreeAdjacencyGraph<N, E> cloneAdd(final E newEdge) {
		return (ImmutableRootedTreeAdjacencyGraph<N, E>) super
				.cloneAdd(newEdge);
	}
	...
	@Override
	public ImmutableRootedTreeAdjacencyGraph<N, E> cloneAdd(
			final Set<N> newNodes, final Set<E> newEdges) {
		return (ImmutableRootedTreeAdjacencyGraph<N, E>) super.cloneAdd(
				newNodes, newEdges);
	}

	@Override
	public ImmutableRootedTreeAdjacencyGraph<N, E> cloneRemove(
	...
	public ImmutableRootedTreeAdjacencyGraph<N, E> cloneRemove(
		...
		return (ImmutableRootedTreeAdjacencyGraph<N, E>) super.cloneRemove(
