 ...
 * @since 2.0
 */
public abstract class AbstractRootedTreeAdjacencyGraph<N, E extends DirectedEdge<N>>
        extends AbstractTreeAdjacencyGraph<N, E> implements
        RootedTreeGraph<N, E>, TreeOptimizedDirectedGraph<N, E> {
    // TODO restrict all edges when added, to make sure they conform to being a
    // rooted tree
     ...
     */
    protected AbstractRootedTreeAdjacencyGraph(
            final DirectedGraph<N, E> copyGraph) {
     ...
     */
    protected AbstractRootedTreeAdjacencyGraph(final Set<N> nodes,
                                               final Set<E> edges) {
        super(nodes, edges);
        if (!this.isRootedTree())
            throw new IllegalArgumentException(
                    "edges do not form a rooted tree");
    }
    ...
    @Override
    public AbstractRootedTreeAdjacencyGraph<N, E> cloneAdd(
            final Set<N> newNodes, final Set<E> newEdges) {
        return (AbstractRootedTreeAdjacencyGraph<N, E>) super.cloneAdd(
                newNodes, newEdges);
    }

    @Override
    public AbstractRootedTreeAdjacencyGraph<N, E> cloneRemove(
            final E edgeToRemove) {
        return (AbstractRootedTreeAdjacencyGraph<N, E>) super
    ...
    public AbstractRootedTreeAdjacencyGraph<N, E> cloneRemove(
        ...
        return (AbstractRootedTreeAdjacencyGraph<N, E>) super.cloneRemove(
