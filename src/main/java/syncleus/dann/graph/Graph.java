...
public interface Graph<N, E extends Edge<N>> extends Serializable, Cloneable,
	 ...
	 *             if specified node is not in the graph.
	 ...
	 *
	 * @param newNodes
	 *            the nodes to add to the cloned graph.
	 * @param newEdges
	 *            the edges to add to the cloned graph.
	 ...
	 *
	 * @param edgeToRemove
	 *            the edge to remove from the cloned graph.
	 ...
	 *
	 * @param deleteNodes
	 *            the nodes to remove from the cloned graph.
	 * @param deleteEdges
	 *            the edges to remove from the cloned graph.
