...
public class ImmutableHyperAdjacencyGraph<N, E extends HyperEdge<N>> extends
	...
	@Override
	public ImmutableHyperAdjacencyGraph<N, E> cloneAdd(final Set<N> newNodes,
			final Set<E> newEdges) {
		return (ImmutableHyperAdjacencyGraph<N, E>) super.cloneAdd(newNodes,
				newEdges);
	}

	@Override
	public ImmutableHyperAdjacencyGraph<N, E> cloneRemove(final E edgeToRemove) {
		return (ImmutableHyperAdjacencyGraph<N, E>) super
	...
	@Override
	public ImmutableHyperAdjacencyGraph<N, E> cloneRemove(
			final Set<N> deleteNodes, final Set<E> deleteEdges) {
		return (ImmutableHyperAdjacencyGraph<N, E>) super.cloneRemove(
