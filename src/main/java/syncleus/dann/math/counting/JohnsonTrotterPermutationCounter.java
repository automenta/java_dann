...
public class JohnsonTrotterPermutationCounter extends
		AbstractPermutationCounter {
	/**
	 * -1: left, 1: right
	 */
	...
	public JohnsonTrotterPermutationCounter(final int setSize,
	...
	private static boolean isMobile(final int[] permutation,
			final int[] mobility, final int index) {
	...
	private static int largestMobileIndex(final int[] permutation,
			final int[] mobility) {
