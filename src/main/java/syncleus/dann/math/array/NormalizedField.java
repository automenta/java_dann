...
public class NormalizedField implements Serializable {
     ...
     * Construct an object.
     *
     * @param theAction The desired action.
     * @param theName   The name of this column.
     */
     ...
     *
     * @param theAction The normalization action to take.
     * @param theName   The name of this field.
     ...
     */
    public NormalizedField(final NormalizationAction theAction,
                           final String theName, final double ahigh, final double alow,
                           final double nhigh, final double nlow) {
    ...
    public NormalizedField(final String theName,
                           final NormalizationAction theAction, final double high,
                           final double low) {
        this.name = theName;
        this.action = theAction;
...
//	}
    ...
    public final void fixSingleValue() {
        if (this.action == NormalizationAction.Normalize) {
            if (Math.abs(this.actualHigh - this.actualLow) < EncogMath.DEFAULT_EPSILON) {
                this.actualHigh += 1;
                this.actualLow -= 1;
            }
        }
    ...
    public final void makeClass(final NormalizationAction theAction,
        ...
        for (int i = classFrom; i < classTo; i++) {
            this.classes.add(new ClassItem(String.valueOf(i), index++));
        }
     ...
     */
    public final void makeClass(final NormalizationAction theAction,
                                final String[] cls, final double high, final double low) {
        if ((theAction != NormalizationAction.Equilateral)
                && (theAction != NormalizationAction.OneOf)
                && (theAction != NormalizationAction.SingleField)) {
            throw new QuantError("Unsupported normalization type");
     ...
     *
     * @param theAction The action for the field.
     */
     ...
     *
     * @param theActualHigh The actual high for the field.
     */
     ...
     *
     * @param theActualLow The theActual low for the field.
     */
     ...
     *
     * @param theNormalizedHigh The normalized high for the field.
     */
     ...
     *
     * @param theNormalizedLow The normalized low for the field.
     */
