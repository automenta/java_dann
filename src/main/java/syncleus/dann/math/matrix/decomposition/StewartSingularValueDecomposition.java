...
public class StewartSingularValueDecomposition implements java.io.Serializable,
     ...
     *
     * @param rectangularMatrix            Rectangular matrix
     * @param calculateRightSingularMatrix if true, allows accessing the rightSingularMatrix
     * @param calculateLeftSingularMatrix  if true, allows accessing the leftSingularMatrix
     */
    ...
    public List<RealNumber> getSingularValues() {
        final List<RealNumber> singularValues = new ArrayList<>(
                this.matrix.length);
