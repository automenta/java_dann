...
public final class MatrixMath {
     ...
     */
    public static SimpleRealMatrix add(final SimpleRealMatrix a, final SimpleRealMatrix b) {
        ...
        return new SimpleRealMatrix(result);
    }
     ...
     */
    public static void copy(final SimpleRealMatrix source, final SimpleRealMatrix target) {
     ...
     */
    public static SimpleRealMatrix deleteCol(final SimpleRealMatrix matrix, final int deleted) {
        if (deleted >= matrix.getCols()) {
            throw new RuntimeException("Can't delete column " + deleted
     ...
     */
    public static SimpleRealMatrix deleteRow(final SimpleRealMatrix matrix, final int deleted) {

        if (deleted >= matrix.getRows()) {
            throw new RuntimeException("Can't delete row " + deleted
     ...
     */
    public static SimpleRealMatrix divide(final SimpleRealMatrix a, final double b) {
        final double[][] result = new double[a.getRows()][a.getCols()];
     ...
     */
    public static double dotProduct(final SimpleRealMatrix a, final SimpleRealMatrix b) {
     ...
     *
     * @param size The number of rows and columns to create. An identity matrix
     *             is always square.
     * @return An identity matrix.
     */
    public static SimpleRealMatrix identity(final int size) {
        if (size < 1) {
            throw new RuntimeException("Identity matrix must be at least of "
                    + "size 1.");
        }

        final SimpleRealMatrix result = new SimpleRealMatrix(size, size);
     ...
     */
    public static SimpleRealMatrix multiply(final SimpleRealMatrix a, final double b) {
        final double[][] result = new double[a.getRows()][a.getCols()];
        final double[][] d = a.getData();
     ...
     * @return The result of the multiplication.
     */
    public static SimpleRealMatrix multiply(final SimpleRealMatrix a, final SimpleRealMatrix b) {
        ...
        final SimpleRealMatrix x = new SimpleRealMatrix(a.getRows(), b.getCols());
     ...
     */
    public static SimpleRealMatrix subtract(final SimpleRealMatrix a, final SimpleRealMatrix b) {
        if (a.getRows() != b.getRows()) {
            throw new RuntimeException(
     ...
     */
    public static SimpleRealMatrix transpose(final SimpleRealMatrix input) {
        ...
        return new SimpleRealMatrix(transposeMatrix);
    }
    ...
    public static double determinant(final SimpleRealMatrix m) {
        return new LuDecomposition2(m).det();
    }

    public static double[] multiply(final SimpleRealMatrix a, final double[] d) {
        final double[] p = new double[a.getRows()];
        final double[][] aData = a.getData();
