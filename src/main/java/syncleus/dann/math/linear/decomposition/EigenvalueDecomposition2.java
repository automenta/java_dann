...
public class EigenvalueDecomposition2 {
	 ...
	 *            Square matrix
	 */
	public EigenvalueDecomposition2(final SimpleRealMatrix matrix) {
	...
	public SimpleRealMatrix getD() {
		final SimpleRealMatrix X = new SimpleRealMatrix(this.n, this.n);
	...
	public SimpleRealMatrix getV() {
		return new SimpleRealMatrix(this.v);
	}
