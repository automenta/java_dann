...
public class QrDecomposition2 {
	 ...
	 *            Rectangular matrix
	 */
	public QrDecomposition2(final SimpleRealMatrix A) {
		// Initialize.
		QR = A.getArrayCopy();
		m = A.getRows();
		n = A.getCols();
	...
	public SimpleRealMatrix solve(final SimpleRealMatrix B) {
		...
		return (new SimpleRealMatrix(X).getMatrix(0, n - 1, 0, nx - 1));
	}
}
