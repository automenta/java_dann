...
public interface Algebraic<F extends Algebraic<? extends F>> extends
		FieldElement<F> {
	/**
	 ...
	 *
	 * @see Math#exp(double)
	 * @return the value <i>e</i><sup><code>this</code></sup>, where <i>e</i> is
	 ...
	 *
	 * @param number
	 *            which root to return, for example 2 for the square root.
