    ...
    public void testMax() {
        ...
        for (int testCount = 0; testCount < 1000; testCount++) {
            ...
            Assert.assertTrue(
                    ...
                    (mutated.doubleValue() != Double.POSITIVE_INFINITY)
                            && (mutated.doubleValue() != Double.NEGATIVE_INFINITY));
        }
    }

    @Test
    public void testMin() {
        final MutableDouble lowValue = new MutableDouble(Double.MAX_VALUE
                * -1.0);
