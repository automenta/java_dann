...
public class TestSimpleMarkovRandomFieldNode {
    ...
    public void testSingleNode() {
        ...
        final GraphicalModelNode<SimpleEnum> testNode = new SimpleGraphicalModelNode<>(
                SimpleEnum.TRUE);
    ...
    public void testDependentNode() {
        ...
        final UndirectedEdge<GraphicalModelNode<SimpleEnum>> testEdge = new ImmutableUndirectedEdge<>(
