...
public class TestEvidenceMap {
    ...
    public void testOverall() {
        ...
        final GraphicalModelNode<TestEnum> influence1 = new SimpleGraphicalModelNode<>(
                TestEnum.FALSE);
        final GraphicalModelNode<TestEnum> influence2 = new SimpleGraphicalModelNode<>(
                TestEnum.FALSE);
        final GraphicalModelNode<TestEnum> influence3 = new SimpleGraphicalModelNode<>(
                TestEnum.FALSE);
