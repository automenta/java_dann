...
import syncleus.dann.graph.search.pathfinding.DijkstraPathFinder;
...
public class TestDijkstraPathFinder
{
	...
	public void testHardGrid()
	{
		...
		final DijkstraPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new DijkstraPathFinder<GridNode, BidirectedEdge<GridNode>>(hardGrid);
	...
	public void testInfinityGrid()
	{
		...
		final DijkstraPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new DijkstraPathFinder<GridNode, BidirectedEdge<GridNode>>(infinityGrid);
