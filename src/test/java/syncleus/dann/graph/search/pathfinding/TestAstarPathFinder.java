...
public class TestAstarPathFinder {
	...
	private static class DistanceHeuristic implements
			HeuristicPathCost<GridNode> {
		@Override
		public double getHeuristicPathCost(final GridNode begin,
				final GridNode end) {
	...
	public void testHardGrid() {
		...
		final AstarPathFinder<GridNode, BidirectedEdge<GridNode>> pathFinder = new AstarPathFinder<GridNode, BidirectedEdge<GridNode>>(
