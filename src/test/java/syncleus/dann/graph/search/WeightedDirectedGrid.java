...
public class WeightedDirectedGrid extends AbstractBidirectedAdjacencyGraph<GridNode, WeightedDirectedEdge<GridNode>>
{
    ...
    @Override
    public Stream<WeightedDirectedEdge<GridNode>> streamAdjacentEdges(GridNode node) {
        return getAdjacentEdges(node).stream();
    }

    @Override
    public Stream<WeightedDirectedEdge<GridNode>> streamTraversableEdges(GridNode node) {
