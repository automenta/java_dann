...
public class TldTest extends OpenCVTestCase {
	...
	public void testGeneratePositiveData(){
		...
		final float[] pExample = TLDUtil.getFloatArray(tld._pExample);
	...
	public static class DummyParamsTld extends ParamsTld{
		public DummyParamsTld(int min_win, int patch_size) {
