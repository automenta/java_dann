...
public class ClauseTest {
	...
	public void testAlwaysFalseLiteralsExcludedOnConstruction() {
		...
		Assert.assertEquals(1, clause.getNumberLiterals());
		Assert.assertEquals(AimaUtil.createSet(LITERAL_P), clause.getLiterals());
		...
		Assert.assertEquals(AimaUtil.createSet(LITERAL_P, new Literal(PropositionSymbol.FALSE, false)), clause.getLiterals());
		
		clause = new Clause(LITERAL_P, new Literal(PropositionSymbol.TRUE));
		Assert.assertEquals(2, clause.getNumberLiterals());
		Assert.assertEquals(AimaUtil.createSet(LITERAL_P, new Literal(PropositionSymbol.TRUE)), clause.getLiterals());
	}
	...
	public void testGetLiterals() {
		...
		clause = new Clause(LITERAL_P, LITERAL_NOT_Q, LITERAL_R);
		Assert.assertEquals(AimaUtil.createSet(LITERAL_P, LITERAL_NOT_Q, LITERAL_R), clause.getLiterals());
	}
	...
	public void testGetPositiveSymbols() {
		...
		clause = new Clause(LITERAL_P);
		Assert.assertEquals(AimaUtil.createSet(new PropositionSymbol("P")), clause.getPositiveSymbols());

		clause = new Clause(LITERAL_P, LITERAL_NOT_Q, LITERAL_R);
		Assert.assertEquals(AimaUtil.createSet(new PropositionSymbol("P"), new PropositionSymbol("R")), clause.getPositiveSymbols());
	}
	...
	public void testGetNegativeSymbols() {
		...
		clause = new Clause(LITERAL_NOT_P);
		Assert.assertEquals(AimaUtil.createSet(new PropositionSymbol("P")), clause.getNegativeSymbols());

		clause = new Clause(LITERAL_NOT_P, LITERAL_NOT_Q, LITERAL_R);
		Assert.assertEquals(AimaUtil.createSet(new PropositionSymbol("P"), new PropositionSymbol("Q")), clause.getNegativeSymbols());
	}
